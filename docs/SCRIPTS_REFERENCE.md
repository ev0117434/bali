...
> **Версия:** актуально на 2026-03-16
> **Язык:** Python 3.10+
...
8. [run.py — лончер всех процессов](#8-runpy--лончер-всех-процессов)
9. [dictionaries/main.py — генератор словарей](#9-dictionariesmainpy--генератор-словарей)
10. [Redis: ключи и каналы](#10-redis-ключи-и-каналы)
11. [Переменные окружения](#11-переменные-окружения)
12. [Форматы файлов и выходных данных](#12-форматы-файлов-и-выходных-данных)
13. [Обработка ошибок и устойчивость](#13-обработка-ошибок-и-устойчивость)
...
## 8. run.py — лончер всех процессов
...
## 9. dictionaries/main.py — генератор словарей
...
## 12. Форматы файлов и выходных данных
